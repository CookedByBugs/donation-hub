  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-8 left-0 right-0 px-6">
        <button
          onClick={() => navigate("/")}
          className="w-full flex items-center justify-center gap-2 bg-gray-50 border border-gray-200 p-3 rounded-xl cursor-pointer hover-bg-primary hover:text-white hover:border-primary transition-all duration-300 text-gray-600 shadow-sm"
        >
