...
const CampaignViewer = () => {
    ...
    return (
        <div className='mt-30'>
            <div className='my-10'>
                <h1 className='text-center text-primary font-bold text-4xl mb-5'>{campaign.title}</h1>
                <div className="text-center">
                    <button className='text-center text-white bg-green-500 px-5 py-1 rounded-full font-semibold capitalize text-xl'>{campaign.category}</button>
                </div>
            </div>
