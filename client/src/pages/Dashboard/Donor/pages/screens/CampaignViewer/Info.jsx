...
const Info = ({ campaign }) => {
  const betaButtons = () => {
    return message.info("Feature under development...");
  };
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="font-bold text-lg text-gray-800">
              {campaign?.createdBy?.NGO}
            </p>
            <p className="text-sm text-gray-500 font-medium">
              Posted by:{" "}
              <span className="text-gray-700">{`${campaign?.createdBy?.firstName} ${campaign?.createdBy?.lastName}`}</span>
            </p>
          </div>
        </div>
          ...
          <div className="relative">
            ...
            >
              <div className="p-2 space-y-1">
                <p
                  onClick={betaButtons}
                  className="hover:bg-primary/5 hover:text-primary p-2 flex items-center rounded-lg cursor-pointer text-sm font-medium transition-colors"
                >
                  Contact Organizer
                </p>
                <p
                ...
                <p
                  onClick={betaButtons}
                  className="hover:bg-red-50 text-red-500 p-2 flex items-center rounded-lg cursor-pointer text-sm font-medium transition-colors"
                >
                  Report Campaign
                </p>
              </div>
