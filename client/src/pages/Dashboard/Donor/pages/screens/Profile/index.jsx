    ...
    <div className="md:pt-32 pt-24 pb-12 md:max-w-[80%] max-w-[95%] w-full mx-auto">
      ...
      <div className="flex md:flex-row flex-col justify-between items-center p-8 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 bg-white gap-8 rounded-3xl mb-8">
        ...
        <Modal
          ...
          okText="Save Picture"
          cancelText="Cancel"
          okButtonProps={{ className: "bg-primary hover:bg-primary-dark border-none font-medium h-10 px-6 rounded-lg shadow-sm" }}
          cancelButtonProps={{ className: "font-medium h-10 px-6 rounded-lg" }}
        >
          <div className="p-4">
            <p className="text-2xl font-extrabold text-gray-800 mb-8 text-center tracking-tight">Change Profile Picture</p>
            <div className="flex justify-center items-center gap-6 sm:gap-10">
              <div className="flex flex-col items-center">
                <span className="text-xs text-gray-400 mb-3 font-semibold uppercase tracking-wider">Current</span>
                <img
                  src={user?.profileImage}
                  alt="Profile image"
              ...
              <div className="flex flex-col items-center">
                <span className="text-xs text-primary mb-3 font-semibold uppercase tracking-wider">New</span>
                {!preview && (
                ...
                {preview && (
                  <div className="relative">
                    ...
                    >
                      <PlusOutlined style={{ transform: 'rotate(45deg)' }} className="text-gray-600 block text-sm" />
                    </div>
                  </div>
                )}
              </div>
