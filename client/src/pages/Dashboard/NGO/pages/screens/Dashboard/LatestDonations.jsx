          ...
          {donations?.slice(0, 3).map((d) => (
            <Col lg={8} md={12} sm={24} xs={24} key={d._id}>
              <div className="rounded-2xl bg-white shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden cursor-default">
                <div className="h-1.5 bg-linear-to-r from-[#25d3c2] to-[#82fdf1]"></div>
                <div className="p-5">
                  ...
                  <p className="text-2xl font-bold m-0 mb-3 bg-linear-to-br from-[#25d3c2] to-[#1a9e91] bg-clip-text text-transparent">
                    ${d.amount}
                  </p>
